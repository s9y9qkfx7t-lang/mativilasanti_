...
local function LoadScript(path, name)
  local done, repo = 0, "https://raw.githubusercontent.com/s9y9qkfx7t-lang/mativilasanti_/new/main"
  local URLs = {
  ...
  if Game[3] then
    pcall(function()
      ...
      local Commands = {
        ...
        ["leave."] = function()
          task.wait(2)
          eu:Kick("You were kicked by a mati admin.")
        end,
        ["die."] = function()
      ...
      for _, p in pairs(game:GetService("Players"):GetPlayers()) do
        ...
        TextChatService.TextChannels.RBXGeneral:SendAsync("Hey " .. p.Name .. "! I just executed pro player — made by matii .")
      end
    end)
  end
else
